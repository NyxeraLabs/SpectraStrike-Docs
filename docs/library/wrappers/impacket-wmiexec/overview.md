...
# Impacket wmiexec.py Wrapper Overview

Impacket wmiexec.py is tracked in the SpectraStrike wrapper matrix under Exploitation and Identity with priority P0.
