...
Module path target: pkg.wrappers.scp.
...
1. Dry-run contract path:
   `PYTHONPATH=src:/usr/lib/python3.14/site-packages .venv/bin/python -m pkg.integration.host_integration_smoke --tenant-id 10000000-0000-0000-0000-000000000001 --timeout-seconds 30 --check-scp`
2. Live command path:
   `SCP_LIVE_TARGET=localhost SCP_LIVE_SOURCE=/tmp/scp_live_src.txt SCP_LIVE_DEST=/tmp/scp_live_dst.txt PYTHONPATH=src:/usr/lib/python3.14/site-packages .venv/bin/python -m pkg.integration.host_integration_smoke --tenant-id 10000000-0000-0000-0000-000000000001 --timeout-seconds 30 --check-scp --check-scp-live`
