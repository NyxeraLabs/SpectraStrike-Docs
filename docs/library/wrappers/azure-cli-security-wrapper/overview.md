...
# Azure CLI Security Wrapper Wrapper Overview

Azure CLI Security Wrapper is tracked in the SpectraStrike wrapper matrix under Cloud and Enterprise Attack Surface with priority P2.
