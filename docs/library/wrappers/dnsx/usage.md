...
Module path target: pkg.wrappers.dnsx.
...
1. Dry-run contract path:
   `PYTHONPATH=src:/usr/lib/python3.14/site-packages .venv/bin/python -m pkg.integration.host_integration_smoke --tenant-id 10000000-0000-0000-0000-000000000001 --timeout-seconds 30 --check-dnsx`
2. Live command path:
   `DNSX_LIVE_TARGET=example.com DNSX_COMMAND='-h' PYTHONPATH=src:/usr/lib/python3.14/site-packages .venv/bin/python -m pkg.integration.host_integration_smoke --tenant-id 10000000-0000-0000-0000-000000000001 --timeout-seconds 30 --check-dnsx --check-dnsx-live`
