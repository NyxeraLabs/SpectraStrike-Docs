...
# Impacket smbexec.py Wrapper Overview

Impacket smbexec.py is tracked in the SpectraStrike wrapper matrix under Exploitation and Identity with priority P0.
